...
#region NIM Audio C SDK native methods
		...
		[DllImport(NIMAudio.NIMAudioNativeDLL, EntryPoint = "nim_audio_reg_play_end_cb", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		...
		[DllImport(NIMAudio.NIMAudioNativeDLL, EntryPoint = "nim_audio_reg_get_play_current_position_cb", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		internal static extern bool nim_audio_reg_get_play_current_position_cb(NIMAudio.NIMRESCodeCb cb, IntPtr user_data);

		[DllImport(NIMAudio.NIMAudioNativeDLL, EntryPoint = "nim_audio_reg_get_capture_time_cb", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		...
		/// </summary>
		/// <returns></returns>
		[DllImport(NIMAudio.NIMAudioNativeDLL, EntryPoint = "nim_audio_get_capture_time", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		...
		/// </summary>
		/// <returns></returns>
		[DllImport(NIMAudio.NIMAudioNativeDLL, EntryPoint = "nim_audio_get_play_current_position", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		...
		/// </summary>
		/// <returns></returns>
		[DllImport(NIMAudio.NIMAudioNativeDLL, EntryPoint = "nim_audio_get_play_time", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		...
		/// <returns></returns>
		[DllImport(NIMAudio.NIMAudioNativeDLL, EntryPoint = "nim_audio_set_play_speaker", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
		...
		/// </summary>
		/// <returns></returns>
		[DllImport(NIMAudio.NIMAudioNativeDLL, EntryPoint = "nim_audio_get_play_speaker", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
